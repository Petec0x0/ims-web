            ...
            <div className="min-h-screen flex">
                <div className="py-12 px-10 w-1/4">
                    <div className="flex space-2 items-center border-b-2 pb-4">
                        <div>
                            <svg xmlns="http://www.w3.org/2000/svg" className="h-14 w-14 text-teal-600" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                    ...
                    <div className="mt-8">
                        <ul className="space-y-10">
                            <li>
                                <a href="/" className="flex items-center text-sm font-semibold text-gray-500 hover:text-teal-600 transition duration-200">
                                    <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6 mr-4 text-gray-400 hover:text-teal-600 transition duration-200" viewBox="0 0 20 20" fill="currentColor">
                            ...
                            <li>
                                <a href="/" className="flex items-center text-sm font-semibold text-gray-500 hover:text-teal-600 transition duration-200">
                                    <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6 mr-4 text-gray-400 hover:text-teal-600 transition duration-200" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                            ...
                            <li>
                                <a href="/" className="flex items-centerx text-sm font-semibold text-gray-500 hover:text-teal-600 transition duration-200">
                                    <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6 mr-4 text-gray-400 hover:text-teal-600 transition duration-200" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                    ...
                    <div className="flex mt-20 space-x-4 items-center">
                        <div>
                            <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6 text-gray-400 hover:text-teal-600 transition duration-200" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M17 16l4-4m0 0l-4-4m4 4H7m6 4v1a3 3 0 01-3 3H6a3 3 0 01-3-3V7a3 3 0 013-3h4a3 3 0 013 3v1" />
                            </svg>
                        </div>
                        <a href="/" className="block font-semibold text-gray-500 hover:text-teal-600 transition duration-200">Logout</a>
                    </div>
                </div>
