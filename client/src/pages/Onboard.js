    ...
    <div className="mx-auto max-w-6xl p-12">
      <div className="flex flex-col md:flex-row justify-center">
        <div className="md:w-1/2 max-w-md flex flex-col justify-center">
          <div className="md:text-4xl text-xl font-black">Maximize your warehouse efficiency</div>
          <div className="text-xl mt-4">Unleash your growth potential</div>
          <p>Have an account? <Link className="text-blue-700" to="/login">Login</Link></p>
        </div>
          ...
          <div className="shadow-md flex-auto max-w-sm p-10 pb-20">
            <div className="w-full">
              ...
              <div className="my-2 bg-white p-1 flex border border-gray-200 rounded">
                <input placeholder="Jhon" className="p-1 px-2 appearance-none outline-none w-full text-gray-800" />
              </div>
            </div>
            <div className="w-full">
              ...
              <div className="my-2 bg-white p-1 flex border border-gray-200 rounded"> 
                <input placeholder="Doe" className="p-1 px-2 appearance-none outline-none w-full text-gray-800" />
              </div>
            </div>
            <div className="w-full">
              ...
              <div className="my-2 bg-white p-1 flex border border-gray-200 rounded">
                <input placeholder="jhon@doe.com" className="p-1 px-2 appearance-none outline-none w-full text-gray-800" />
              </div>
            </div>
