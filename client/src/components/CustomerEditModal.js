...
const CustomerEditModal = ({ toggleEditModal, itemDetails, isEditModalOpen, formInputData, setFormInputData }) => {
    ...
    const handleSubmit = (e) => {
        ...
        if (formInputData.customerContact === '' || formInputData.customerAddress === '') {
                    ...
                    <div className="scale-100 w-[900px] min-w-[250px] bg-gray-200 rounded-lg px-3 pb-3 pt-7 mx-3 md:m-5 relative">
                        ...
                        <div className="flex flex-col gap-5">
                            <div className="flex flex-wrap items-center gap-2">
                                <span className="block font-bold text-xl">{itemDetails.customerName}</span>
                            ...
                            <div className="bg-white rounded-lg p-2 sm:p-5">
                                <div className="md:flex md:flex-row md:space-x-4 w-full text-xs">
                                    <div className="w-full flex flex-col mb-3">
                                        <label className="font-semibold text-gray-600 py-2">Customer Contact <abbr title="required">*</abbr></label>
                                        <input onChange={handleFormInput} value={formInputData.customerContact} placeholder="Customer Contact " className="appearance-none block w-full bg-grey-lighter text-grey-darker border border-grey-lighter rounded-lg h-10 px-4" required="required" type="text" name="customerContact" />
                                    </div>
                                    <div className="w-full flex flex-col mb-3">
                                        <label className="font-semibold text-gray-600 py-2">Customer Address <abbr title="required">*</abbr></label>
                                        <input onChange={handleFormInput} value={formInputData.customerAddress} placeholder="Customer Address " className="appearance-none block w-full bg-grey-lighter text-grey-darker border border-grey-lighter rounded-lg h-10 px-4" required="required" type="text" name="customerAddress" />
                                    </div>
                                </div>
