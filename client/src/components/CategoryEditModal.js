...
const CategoryEditModal = ({ toggleEditModal, itemDetails, isEditModalOpen, formInputData, setFormInputData }) => {
                    ...
                    <div className="scale-100 w-[900px] min-w-[250px] bg-gray-200 rounded-lg px-3 pb-3 pt-7 mx-3 md:m-5 relative">
                        ...
                        <div className="flex flex-col gap-5">
                            <div className="flex flex-wrap items-center gap-2">
                                <span className="block font-bold text-xl">{itemDetails.categoryName}</span>
