...
const AddCustomer = () => {
  ...
  const handleSubmit = (e) => {
    ...
    if (formInputData.customerName === '' ||
      formInputData.customerContact === '' ||
      formInputData.customerAddress === '') {
                ...
                <div className="flex flex-wrap -m-2">
                  <div className="p-2 md:w-1/2">
                    <div className="relative">
                      <label htmlFor="name" className="leading-7 text-sm text-gray-600">Customer Name</label>
                      <input onChange={handleFormInput} type="text" id="customerName" name="customerName" className="appearance-none block w-full bg-grey-lighter text-grey-darker border border-grey-lighter rounded-lg h-10 px-4" />
                    </div>
                  </div>
                  <div className="p-2 md:w-1/2">
                    <div className="relative">
                      <label htmlFor="email" className="leading-7 text-sm text-gray-600">Customer Contact</label>
                      <input onChange={handleFormInput} type="text" id="customerContact" name="customerContact" className="appearance-none block w-full bg-grey-lighter text-grey-darker border border-grey-lighter rounded-lg h-10 px-4" />
                    </div>
                  </div>
                  <div className="p-2 w-full">
                    <div className="relative">
                      <label htmlFor="message" className="leading-7 text-sm text-gray-600">Address</label>
                      <input onChange={handleFormInput} type="text" id="customerAddress" name="customerAddress" className="appearance-none block w-full bg-grey-lighter text-grey-darker border border-grey-lighter rounded-lg h-10 px-4" />
                    </div>
                  </div>
                  <div className="p-2 w-full">
